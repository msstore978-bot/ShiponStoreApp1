...
android {
    namespace = "com.shiponstore.customermanagement"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.shiponstore.customermanagement"
        // Android 8.0 (Oreo) and above, per V1 requirement.
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0-offline-foundation"
...
dependencies {
    ...
    // --- Lifecycle / ViewModel / LiveData (state management layer) ---
    ...
    // --- WorkManager (reserved for the future Sync Engine — not wired up in V1) ---
